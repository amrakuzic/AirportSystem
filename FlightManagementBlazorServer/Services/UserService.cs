...
namespace FlightManagementBlazorServer.Services
{
    public class UserService
    {
        ...
        public async Task<List<User>> GetCheckedUsersAsync()
        {
            return await _httpClient.GetFromJsonAsync<List<User>>($"{BaseApiUrl}/checkedUsers");
        }
        public async Task<List<User>> GetAllUsersAsync()
        {
            return await _httpClient.GetFromJsonAsync<List<User>>($"{BaseApiUrl}/allUsers");
        }
    }
}
